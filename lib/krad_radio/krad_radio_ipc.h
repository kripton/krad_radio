...
#define EBML_ID_KRAD_RADIO_MESSAGE_TYPE 0x66FC
#define EBML_ID_KRAD_RADIO_MESSAGE_PAYLOAD 0x66BF

#define EBML_ID_KRAD_RADIO_UNIT_DESTROYED 0x7BA9
#define EBML_ID_KRAD_RADIO_ADDRESS 0x437E
#define EBML_ID_KRAD_RADIO_UNIT 0xAA
#define EBML_ID_KRAD_RADIO_SUBUNIT 0xAA
#define EBML_ID_KRAD_RADIO_SUBUNIT_ID_NAME 0x437E
