...
**
** Created: Sun Jan 20 21:55:26 2013
...
static const char qt_meta_stringdata_BroadcastThread[] = {
    "BroadcastThread\0"
};
...
const QMetaObjectExtraData BroadcastThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BroadcastThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_BroadcastThread,
      qt_meta_data_BroadcastThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BroadcastThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BroadcastThread))
