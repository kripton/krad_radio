...
../lib/krad_system/krad_system.c ../lib/krad_transmitter/krad_transmitter.c ../lib/krad_ring/krad_ring.c ../lib/krad_ebml/krad_ebml.c krad_webm_audio_extract.c -o krad_webm_audio_extract \
